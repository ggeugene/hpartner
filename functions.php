    ...
    if($query->have_posts()) {
        ...
        foreach($query->posts as $post) {
            ...
            if(!empty(get_the_post_thumbnail_url($post->ID))) {
                ...
                $string .= '<a class="custom_post_item-img_link dummy_img" href="' . get_the_permalink($post->ID) . '" style="background-image:url(/hpartner/wp-content/themes/divichild/img/dummy_image.png)"></a>'; 
            }
