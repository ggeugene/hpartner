            ...
            ?>
				...
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="/hpartner/wp-content/themes/divichild/img/healthpartner-logo.svg" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
                </div>
                <div class="widget widget-work_hours">
                    <?php dynamic_sidebar( 'work-hours' ); ?>
                </div>
                <div class="widget widget-phones">
